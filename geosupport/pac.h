...
extern "C" {
 ...
 /*  Add new 2 byte Bike Lane and Max Str Width       TLV 9/2016 V16.4*/
 /*                                                                   */
 /*********************************************************************/
 /*                                                                   */
...
//char blockface_id[7];    /** V16.1 **   *blockface id 10 bytes long*/
  char bike_lane_2[2];                   /*Bike Lane has 2 bytes     */
                                         /* numeric value            */
  char filler05[5];                      /* moved in wa2 of F1EX     */
  char status;                           /*                          */
  char str_width[3];                     /*                          */
